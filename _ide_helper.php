<?php
/**
 * A helper files for Laravel 5, to provide autocomplete information to your IDE
 ...
 */
namespace  {
    exit("This files should not be included, only analyzed by your IDE");
}
...
namespace Illuminate\Support\Facades {
    ...
    class App {
        ...
        /**
         * Set the directory for the environment files.
         *
         * @param string $path
         * @return $this 
         * @static 
        ...
        /**
         * Set the environment files to be loaded during bootstrapping.
         *
         * @param string $file
         * @return $this 
         * @static 
        ...
        /**
         * Get the environment files the application is using.
         *
         * @return string 
         * @static 
         */
        ...
        /**
         * Get the fully qualified path to the environment files.
         *
         * @return string 
         * @static 
         */
        ...
        /**
         * Get the path to the cached services.php files.
         *
         * @return string 
         * @static 
         */
        ...
        /**
         * Get the path to the configuration cache files.
         *
         * @return string 
         * @static 
         */
        ...
        /**
         * Get the path to the routes cache files.
         *
         * @return string 
         * @static 
         */
    ...
    class File {
        ...
        /**
         * Determine if a files or directory exists.
         *
         * @param string $path
         * @return bool 
         * @static 
        ...
        /**
         * Get contents of a files with shared access.
         *
         * @param string $path
         * @return string 
         * @static 
        ...
        /**
         * Get the returned value of a files.
         *
         * @param string $path
         * @return mixed 
         * @throws \Illuminate\Contracts\Filesystem\FileNotFoundException
        ...
        /**
         * Get or set UNIX mode of a files or directory.
         *
         * @param string $path
         * @param int $mode
         * @return mixed 
        ...
        /**
         * Delete the files at a given path.
         *
        ...
        /**
         * Move a files to a new location.
         *
         * @param string $path
         * @param string $target
         * @return bool 
        ...
        /**
         * Copy a files to a new location.
         *
         * @param string $path
         * @param string $target
         * @return bool 
        ...
        /**
         * Create a hard link to the target files or directory.
         *
         * @param string $target
         * @param string $link
         * @return void 
        ...
        /**
         * Extract the files name from a files path.
         *
         * @param string $path
         * @return string 
         * @static 
        ...
        /**
         * Extract the trailing name component from a files path.
         *
         * @param string $path
         * @return string 
         * @static 
        ...
        /**
         * Extract the parent directory from a files path.
         *
         * @param string $path
         * @return string 
         * @static 
        ...
        /**
         * Extract the files extension from a files path.
         *
         * @param string $path
         * @return string 
         * @static 
        ...
        /**
         * Get the files type of a given files.
         *
         * @param string $path
         * @return string 
         * @static 
        ...
        /**
         * Get the mime-type of a given files.
         *
         * @param string $path
         * @return string|false 
         * @static 
        ...
        /**
         * Get the files size of a given files.
         *
         * @param string $path
         * @return int 
         * @static 
        ...
        /**
         * Determine if the given path is a files.
         *
         * @param string $file
         * @return bool 
         * @static 
    ...
    class Log {
        ...
        /**
         * Register a daily files log handler.
         *
         * @param string $path
         * @param int $days
         * @param string $level
    ...
    class Request {
         ...
         * 
         * Suppose that an index.php files instantiates this request object:
         * 
        ...
        /**
         * Determine if the uploaded data contains a files.
         *
         * @param string $key
         * @return bool 
         * @static 
    ...
    class Response {
        ...
        /**
         * Create a new files download response.
         *
        ...
        /**
         * Return the raw contents of a binary files.
         *
         * @param \SplFileInfo|string $file
         * @param array $headers
         * @return \Symfony\Component\HttpFoundation\BinaryFileResponse 
    ...
    class Storage {
        ...
        /**
         * Store the uploaded files on the disk.
         *
         * @param string $path
        ...
        /**
         * Store the uploaded files on the disk with a given name.
         *
         * @param string $path
        ...
        /**
         * Get the URL for the files at the given path.
         *
         * @param string $path
         * @return string 
         * @static 
